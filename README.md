...
- `--ip-ban-list-key [ip-ban-list-key]` - Public key of an IP ban list to subscribe to. Can be hex or z32. Can be specified multiple times.
- `--push-gateway-key [push-gateway-key]` - Public key of a push gateway to forward notifications to. Can be hex or z32. Can be specified multiple times.
